...
// Sysora Platform - AWS Deployment using AWS SDK v3
import { 
    S3Client, 
    CreateBucketCommand, 
    PutObjectCommand, 
...
async function deploy() {
    ...
    console.log('Using AWS SDK v3 for JavaScript');
    console.log('='.repeat(50));
    ...
    try {
        ...
        console.log(`🏨 Hotel Access: Add /hotel to the URL`);
        console.log(`👨‍💼 Admin Access: Add /admin to the URL`);
        console.log(`💰 Estimated cost: $1-5/month`);
        console.log('='.repeat(50));
        
        log.success('🎊 Deployment completed successfully!');
        log.info('Next steps: Set up custom domain and SSL certificate');
