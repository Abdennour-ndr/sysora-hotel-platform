...
const AnalyticsManagementFR = () => {
  const [timeRange, setTimeRange] = useState('30d');
  const [refreshing, setRefreshing] = useState(false);

  // Données fictives - dans une vraie application, elles viendraient de l'API
  const analyticsData = {
    overview: {
      totalRevenue: 125000,
      revenueGrowth: 12.5,
    ...
    chartData: {
      revenue: [
        { month: 'Janvier', value: 85000 },
        { month: 'Février', value: 92000 },
        { month: 'Mars', value: 78000 },
        { month: 'Avril', value: 105000 },
        { month: 'Mai', value: 118000 },
        { month: 'Juin', value: 125000 }
      ],
      users: [
        { month: 'Janvier', value: 1200 },
        { month: 'Février', value: 1450 },
        { month: 'Mars', value: 1680 },
        { month: 'Avril', value: 2100 },
        { month: 'Mai', value: 2450 },
        { month: 'Juin', value: 2847 }
      ]
    },
    topHotels: [
      { name: 'Hôtel Ritz Carlton', revenue: 25000, growth: 15.2 },
      { name: 'Hôtel Four Seasons', revenue: 22000, growth: 12.8 },
      { name: 'Hôtel Hilton', revenue: 18500, growth: 8.9 },
      { name: 'Hôtel Marriott', revenue: 16200, growth: 6.4 },
      { name: 'Hôtel Sheraton', revenue: 14800, growth: 4.2 }
    ]
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-sysora-midnight">Analyses Avancées</h2>
          <p className="text-gray-600">Rapports détaillés et analyses</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          ...
          <div>
            <p className="text-sm text-gray-600 mb-1">Hôtels Totaux</p>
            <p className="text-3xl font-bold text-gray-900">
              {formatNumber(analyticsData.overview.totalHotels)}
            </p>
            <p className="text-xs text-gray-500 mt-1">Hôtels enregistrés</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Visiteurs vers clients</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Croissance des Revenus</h3>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Hôtels les Plus Performants</h3>
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-600">Mises à jour en direct</span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-2xl">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Nouvel enregistrement d'hôtel</p>
          ...
          <div className="flex items-center space-x-4 p-4 bg-green-50 rounded-2xl">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Nouvel abonnement</p>
              <p className="text-xs text-gray-500">Plan Premium - 299€/mois</p>
            </div>
            <span className="text-xs text-gray-500">Il y a 12 minutes</span>
          </div>
          
          <div className="flex items-center space-x-4 p-4 bg-yellow-50 rounded-2xl">
            <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Mise à niveau du plan</p>
              <p className="text-xs text-gray-500">Mise à niveau de Basic vers Standard</p>
            </div>
            <span className="text-xs text-gray-500">Il y a 25 minutes</span>
          </div>
        </div>
      </div>
    </div>
...
export default AnalyticsManagementFR;
