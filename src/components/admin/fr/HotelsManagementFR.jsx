...
const HotelsManagementFR = ({ hotels = [] }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-sysora-midnight">Gestion des Hôtels</h2>
          <p className="text-gray-600">Voir et gérer tous les hôtels</p>
        </div>
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-gray-100">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Total des Hôtels</p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Essai</p>
          </div>
          <div className="text-center">
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {filteredHotels.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Aucun hôtel ne correspond aux critères de recherche</p>
          </div>
        )}
      </div>
    </div>
...
export default HotelsManagementFR;
