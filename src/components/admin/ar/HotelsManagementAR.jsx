...
const HotelsManagementAR = ({ hotels = [] }) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-sysora-midnight">إدارة الفنادق</h2>
          <p className="text-sm sm:text-base text-gray-600">عرض وإدارة جميع الفنادق المسجلة في المنصة</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-3 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-sysora-mint focus:border-sysora-mint text-right"
            />
          </div>
          ...
          <div className="flex items-center space-x-4 space-x-reverse">
            <div className="relative">
              ...
              <select
                ...
                className="pr-10 pl-8 py-3 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-sysora-mint focus:border-sysora-mint bg-white text-right"
              >
...
export default HotelsManagementAR;
