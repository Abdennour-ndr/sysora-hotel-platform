...
const UsersManagementEN = ({ users = [] }) => {
  ...
  const getRoleBadge = (role) => {
    const roleConfig = {
      hotel_owner: { color: 'bg-purple-100 text-purple-800', text: 'Hotel Owner' },
      manager: { color: 'bg-blue-100 text-blue-800', text: 'Manager' },
      staff: { color: 'bg-gray-100 text-gray-800', text: 'Staff' },
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-sysora-midnight">User Management</h2>
          <p className="text-sm sm:text-base text-gray-600">Manage platform users</p>
        </div>
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {filteredUsers.length === 0 && (
          <div className="text-center py-8 sm:py-12">
            ...
            <p className="text-sm sm:text-base text-gray-500">No users match the search criteria</p>
          </div>
        )}
      </div>
    </div>
...
export default UsersManagementEN;
